...
4. ALWAYS prioritize and lead with the Collective Agreement (Main Agreement) and Primary Statutes (e.g., BC Labour Relations Code) as the primary authorities.
